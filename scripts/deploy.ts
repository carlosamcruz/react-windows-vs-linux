...
import { ReactWindowsVsLinux } from '../src/contracts/reactWindowsVsLinux'
...
async function main() {
    await ReactWindowsVsLinux.loadArtifact()
    ...
    const instance = new ReactWindowsVsLinux(
    ...
    console.log('ReactWindowsVsLinux contract was successfully deployed!')
